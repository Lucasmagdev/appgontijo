...
const initialForm: ObraDetail = {
  ...
  projetoGontijo: true, valorProjeto: null, fatMinimoTipo: 'global', fatMinimoValor: null, fatMinimoDias: null, usaBits: false, valorBits: null, acrescimoBitPct: null, transporteNoturno: false, icamento: false, seguroPct: null, totalProducao: null, mobilizacao: null, desmobilizacao: null, totalGeral: null,
  responsavelComercialGontijo: '', telComercialGontijo: '', responsavelContratante: '', telContratante: '', observacoes: '', engenheiroResponsavel: '',
      ...
      {(!isEditing || obraQuery.data) && <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <ObraSection title="Questões Contratuais" sectionKey="contrato" activeSection={activeSection} setActiveSection={setActiveSection}>
          <div className="form-grid">
            ...
            <div style={gridSpan(4)}><label className="field-label">Qual o valor do projeto?</label><NumberInput className="field-input" value={form.valorProjeto} onChange={(value) => setField('valorProjeto', value)} /></div>
            ...
            <div style={gridSpan(4)}><label className="field-label">Faturamento mínimo, diário ou global</label><NumberInput className="field-input" value={form.faturamentoMinimoDiarioGlobal} onChange={(value) => setField('faturamentoMinimoDiarioGlobal', value)} /></div>
            <div style={gridSpan(4)}><label className="field-label">Valor Faturamento Mínimo (R$)</label><NumberInput className="field-input" placeholder="Ex: 1000,00" value={form.fatMinimoValor} onChange={(value) => setField('fatMinimoValor', value)} /></div>
            ...
            <div style={gridSpan(4)}><label className="field-label">Acréscimo Bit (%)</label><NumberInput className="field-input" placeholder="Ex: 100" value={form.acrescimoBitPct} onChange={(value) => setField('acrescimoBitPct', value)} /></div>
            <div style={gridSpan(4)}><label className="field-label">Acréscimo de transporte noturno</label><NumberInput className="field-input" value={form.acrescimoTransporteNoturno} onChange={(value) => setField('acrescimoTransporteNoturno', value)} /></div>
            ...
            <div style={gridSpan(6)}><label className="field-label">Valor do içamento</label><NumberInput className="field-input" value={form.valorIcamento} onChange={(value) => setField('valorIcamento', value)} /></div>
            ...
            <div style={gridSpan(6)}><label className="field-label">Valor do seguro</label><NumberInput className="field-input" value={form.valorSeguro} onChange={(value) => setField('valorSeguro', value)} /></div>
          </div>
                ...
                <tbody>
                  {form.producao.map((item, index) => (
                    <tr key={`prod-${index}`} className="bg-white">
                      ...
                      <td className="p-3 border-b border-slate-100">
                        <NumberInput className="field-input" value={item.profundidade} onChange={(value) => updateProducao(index, 'profundidade', value)} placeholder="Ex.: 10" />
                      </td>
                      <td className="p-3 border-b border-slate-100">
                        <NumberInput className="field-input" value={item.qtdEstacas} onChange={(value) => updateProducao(index, 'qtdEstacas', value)} placeholder="Ex.: 10" />
                      </td>
                      <td className="p-3 border-b border-slate-100">
                        <NumberInput className="field-input" value={item.preco} onChange={(value) => updateProducao(index, 'preco', value)} placeholder="Ex.: 85,40" />
                      </td>
                      <td className="p-3 border-b border-slate-100">
                  ...
                  <tr><td colSpan={4} className="px-4 py-3 font-black uppercase tracking-[0.08em] text-slate-600 border-b border-slate-100">Valor da mobilização</td><td className="px-4 py-2 border-b border-slate-100"><NumberInput className="field-input" value={form.mobilizacao} onChange={(value) => setField('mobilizacao', value)} /></td><td className="border-b border-slate-100" /></tr>
                  <tr><td colSpan={4} className="px-4 py-3 font-black uppercase tracking-[0.08em] text-slate-600 border-b border-slate-100">Valor da desmobilização</td><td className="px-4 py-2 border-b border-slate-100"><NumberInput className="field-input" value={form.desmobilizacao} onChange={(value) => setField('desmobilizacao', value)} /></td><td className="border-b border-slate-100" /></tr>
        ...
        <ObraSection title="Responsabilidades" sectionKey="responsabilidades" activeSection={activeSection} setActiveSection={setActiveSection}>
          <div className="form-grid">
            ...
            <div style={gridSpan(6)}><label className="field-label">Valor da Integração</label><NumberInput className="field-input" value={form.valorIntegracao} onChange={(value) => setField('valorIntegracao', value)} /></div>
            ...
            <div style={gridSpan(6)}><label className="field-label">Valor da Documentação</label><NumberInput className="field-input" value={form.valorDocumentacao} onChange={(value) => setField('valorDocumentacao', value)} /></div>
            ...
            <div style={gridSpan(6)}><label className="field-label">Valor da Mob. Interna</label><NumberInput className="field-input" value={form.valorMobilizacaoInterna} onChange={(value) => setField('valorMobilizacaoInterna', value)} /></div>
            ...
            <div style={gridSpan(6)}><label className="field-label">Valor da limpeza do trado</label><NumberInput className="field-input" value={form.valorLimpezaTrado} onChange={(value) => setField('valorLimpezaTrado', value)} /></div>
            ...
            <div style={gridSpan(6)}><label className="field-label">Valor hospedagem</label><NumberInput className="field-input" value={form.valorHospedagem} onChange={(value) => setField('valorHospedagem', value)} /></div>
            ...
            <div style={gridSpan(6)}><label className="field-label">Valor café da manhã</label><NumberInput className="field-input" value={form.valorCafeManha} onChange={(value) => setField('valorCafeManha', value)} /></div>
            ...
            <div style={gridSpan(6)}><label className="field-label">Valor almoço</label><NumberInput className="field-input" value={form.valorAlmoco} onChange={(value) => setField('valorAlmoco', value)} /></div>
            ...
            <div style={gridSpan(6)}><label className="field-label">Valor jantar</label><NumberInput className="field-input" value={form.valorJantar} onChange={(value) => setField('valorJantar', value)} /></div>
        ...
        <ObraSection title="Dados de Faturamento" sectionKey="faturamento" activeSection={activeSection} setActiveSection={setActiveSection}>
          ...
          <div className="form-grid">
            ...
            <div style={gridSpan(6)}><label className="field-label">ISSQN (%)</label><NumberInput className="field-input" value={form.issqnPct} onChange={(value) => setField('issqnPct', value)} /></div>
        ...
        <ObraSection title="Contatos" sectionKey="contatos" activeSection={activeSection} setActiveSection={setActiveSection}>
          <div className="form-grid">
            <div style={gridSpan(12)}><label className="field-label">Engenheiro Responsável</label><input className="field-input" value={form.engenheiroResponsavel} placeholder="Nome do engenheiro responsável pela obra" onChange={(event) => setField('engenheiroResponsavel', event.target.value)} /></div>
