...
export default function OperadorLoginPage() {
  ...
  return (
    <div className="relative flex min-h-[100dvh] items-center justify-center overflow-hidden bg-[#0f1117] p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.06] p-8 shadow-[0_24px_64px_rgba(0,0,0,0.5)] backdrop-blur-xl">
          <div className="mb-7 border-l-4 border-[#c60926] pl-4">
            ...
            <p className="mt-1 text-sm text-white/50">Operador — entre com seu CPF e senha.</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="mb-1.5 block text-xs font-semibold uppercase tracking-wider text-white/60" htmlFor="op-cpf">
                CPF
              </label>
              <input
                id="op-cpf"
            ...
            <div>
              <label className="mb-1.5 block text-xs font-semibold uppercase tracking-wider text-white/60" htmlFor="op-senha">
                Senha
              </label>
