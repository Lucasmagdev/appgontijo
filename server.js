...
function formatDateBr(dateText) {
  ...
  // PDF que SOBRESCREVIA esta em runtime. Mantida a logica que estava de fato
  // ativa (regex YYYY-MM-DD). Ver docs/REFATORACAO.md.
...
// safeParseJsonObject -> lib/helpers.js

// firstFilledText -> lib/helpers.js

// formatSqlDateTime -> lib/helpers.js
...
// isSignatureLinkExpired -> lib/helpers.js
